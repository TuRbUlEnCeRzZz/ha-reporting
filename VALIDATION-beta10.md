# Validation — 0.1.0-beta.10

## Périmètre

Beta.10 reprend le socle documentaire local de beta.9 et intègre les finitions du moteur PDF natif sans modifier le moteur statistique ni le transport AI Task WebSocket :
...
Ces éléments sont réservés à beta.11 et versions suivantes.
